...
The volume functions allow for the calculation of volumes and surface areas of common three-dimensional shapes.
...
The function `surf_area_cube(side_len)` calculates the surface area of a cube with the provided dimension. The user must provide the `side_len` dimension, which is the length of one edge of the cube.

The inputs for all parameters must be numeric and greater than 0, or the function will throw an error.
...
The function `surf_area_cylinder(base_radius, height)` calculates the surface area of a cylinder with the provided dimension. The user must provide the `base_radius` dimension, which is the radius of the base of the cylinder, and the `height` dimension, which is the height.

The inputs for all parameters must be numeric and greater than 0, or the function will throw an error.

```{r}
surf_area_cylinder(2, 7)
```
...
The function `surf_area_sphere(radius)` calculates the surface area of a sphere with the provided dimension. The user must provide the `radius` dimension, which is the radius of the sphere.
...
#### Surface Area Hemisphere

The function `surf_area_hemisphere(base_radius)` calculates the surface area of a hemisphere with the provided dimension. The user must provide the `base_radius` dimension, which is the radius of the base of the hemisphere.

The inputs for all parameters must be numeric and greater than 0, or the function will throw an error.

```{r}
surf_area_hemisphere(3)
```
...
#### Surface Area Capsule

The function `surf_area_capsule(side_len, radius)` calculates the surface area of a capsule with the provided dimension. The user must provide the `side_len` dimension, which is the lenght of one side of the capsule, and the `radius` dimension, which is the radius.

The inputs for all parameters must be numeric and greater than 0, or the function will throw an error.

```{r}
surf_area_capsule(3,5)
```
...
```{r}
volume_rectangular_solid(2, 5, 7)
```

#### Surface Area Rectangular Solid

The function `surf_area_rectangular_solid(lenght, width, height)` calculates the surface area of a rectangular solid with the provided dimension. The user must provide the `length` dimension, which is the length of the base of the solid, the `width`, which is the width of the solid, and the `height` dimension, which is the height.

The inputs for all parameters must be numeric and greater than 0, or the function will throw an error.

```{r}
surf_area_rectangular_solid(2, 5, 7)
```
...
#### Surface Area Tetrahedron

The function `surf_area_tetrahedron(length)` calculates the surface area of a tetrahedron with the provided dimension. The user must provide the `length` dimension, which is the length of the tetrahedron.

The inputs for all parameters must be numeric and greater than 0, or the function will throw an error.

```{r}
surf_area_tetrahedron(10)
```
