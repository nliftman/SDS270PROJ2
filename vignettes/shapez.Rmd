...
The function `surf_area_cylinder(base_radius, height)` calculates the surface area of a cube with the provided dimension. The user must provide the `base_radius` dimension, which is the radius of the base of the cylinder, and the `height` dimension, which is the height.
